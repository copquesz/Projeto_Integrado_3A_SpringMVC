                    ...
                    <div class="col-md-12 col-sm-12 col-xs-12">
                        ...
                        <div class="panel panel-default">
                            <div class="panel-heading">
                                ...
                                <c:if test="${isProximoAtendimento}">
                                    <a href="atender-subservico" class="btn btn-success pull-right">Próximo Sub-Serviço</a>
                                </c:if>
                                <c:if test="${not isProximoAtendimento}">
                                    <a href="finalizar-senha" class="btn btn-danger pull-right">Finalizar Senha</a>
                                </c:if>
                            </div> 
